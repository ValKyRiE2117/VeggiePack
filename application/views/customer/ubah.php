                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    <form action="<?= base_url('customer/proses_ubah/' . $customer->kode) ?>"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="username_customer"><strong>Username
                                                        Customer</strong></label>
                                                <input type="text" name="username_customer" placeholder="Username"
                                                    autocomplete="off" class="form-control" required
                                                    value="<?= $customer->username_customer ?>">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="password_customer"><strong>Password
                                                        Customer</strong></label>
                                                <input type="text" name="password_customer" placeholder="Password"
                                                    autocomplete="off" class="form-control" required
