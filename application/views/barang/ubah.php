                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="kode_barang" placeholder="Masukkan Kode Barang"
                                                    autocomplete="off" class="form-control" required maxlength="8"
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input class="form-control" type="file" id="formFile" required
                                                    value="<?= base_url('./uploads/' . $barang->gambar) ?>"
                                                    name="gambar">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="tgl_barang_dibuat"><strong>Tanggal barang
                                                        dibuat</strong></label>
                                                <input type="date" name="tgl_barang_dibuat"
                                                    placeholder="Masukkan Nama Barang" autocomplete="off"
                                                    class="form-control" required
                                                    value="<?= $barang->tgl_barang_dibuat ?>">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <label for="deskripsi_barang"><strong>Deskripsi barang</strong></label>
                                                <textarea type="textarea" name="deskripsi_barang" class="form-control"
                                                    required><?php echo htmlspecialchars( $barang->deskripsi_barang); ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="harga_barang" placeholder="Masukkan Harga"
                                                    autocomplete="off" class="form-control" required
